...
vm.runInContext(fs.readFileSync('jinsulmap/JINSUL_MAP_v3.6.0.html','utf8').match(/^function scanSiteAutoFill[^]*?^}/m)[0],c);
...
(async()=>{
  ...
  fs.writeFileSync('work/enrich-test-results-v360.json',JSON.stringify({type:'Local and mocked tests, not live API',passed:n},null,2));console.log(n+' passed');
