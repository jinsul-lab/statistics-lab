...
const html=fs.readFileSync('jinsulmap/JINSUL_MAP_v3.6.7.html','utf8');
...
t('version exactly three single digit fields',()=>{assert.ok(html.includes('<title>JINSUL MAP v3.6.7</title>'));assert.ok(!html.includes('3.5.11'));assert.ok(html.includes('<div class="brand">JINSUL MAP</div>'))});
