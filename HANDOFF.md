...
## 기준 파일
- 현재 로컬 버전: `3.5.7`
- 다음 작업 기준: `jinsulmap/JINSUL_MAP_v3.5.7.html`
- 기존 루트 사본: `JINSUL_MAP_v3.5.2.html`. 이전 작업에서 함께 업로드한 사본이며, 별도의 개발 기준으로 사용하지 않는다.
- 상세 검증: `jinsulmap/UI_VERIFICATION_v3.5.7.md`
- 실행 주소: https://jinsul-lab.github.io/statistics-lab/jinsulmap/

## 검증과 저장소 상태
- v3.5.7: 대비·팝업 크기·인구 통계 차트 개선. 로컬/모의 57개 통과. 왕십리 실제 실시간·예측·방문인구·분기상권·SGIS 표시 확인. 초기 앱 업로드 `cc13403ea45a751ad09cd7758285a1915df48e5c`, 마무리 스타일/문서는 후속 커밋. 상세 UI 보고서 참조.
