...
## 기준 파일
- 현재 로컬 버전: `3.5.9`
- 다음 작업 기준: `jinsulmap/JINSUL_MAP_v3.5.9.html`
...
## 검증과 저장소 상태
- v3.5.9: 입지자료·임장 작성, 저장/백업/독립HTML/A4, 경쟁의원 비교·매출 참고, 지역 검색 범위 구분. 로컬/모의92개 통과. 부천 샘플A4 PDF3페이지 검수. 용인시 대표지점 스캔에서 SGIS 코드-1 미연결 확인. 상세 입지 검증 보고서 참조.
